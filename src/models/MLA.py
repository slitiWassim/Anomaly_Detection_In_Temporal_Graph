...
# ═══════════════════════════════════════════════════════════════════════════════
# 10.  MLAProjection  — NEW  (Multi-Head Latent Attention projections)
#
...
class TemporalTrustAttention(MessagePassing):
    ...
    def message(self,
        ...
        # ── [4] Weighted message ───────────────────────────────────────────────
        #
        #  V carries the target+edge semantic content (no RoPE).
        #  Weight each head's value by its attention coefficient, then flatten.
